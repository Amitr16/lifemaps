...
export default function WorkAssetsPage() {
  ...
  const columns = [{ field:'stream', headerName:'Income Stream' }, { field:'amount', headerName:'Annual Amount', type:'number' }];

  return (
    <div className="max-w-6xl mx-auto p-4 space-y-4">
      <GraphDock />
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold">WorkAssetsPage</h1>
      </div>
